<template>
  <article class="nj-article">
    <h3 class="nj-article__title">《婚姻登记工作规范》政策解读</h3>
    <p>
      为进一步规范婚姻登记工作，最近，民政部下发了《民政部关于印发婚姻登记工作规范的通知》，相关负责人就社会关心的问题回答了记者提问。
    </p>
    <h4>
    ...
    <h4>问：为什么增加乡（镇）婚姻登记机关的设置标准和要求？</h4>
    <p>
    ...
    <h4>问：有媒体报道婚姻机关乱收费、搭车收费等现象，民政部将有哪些措施来治理？</h4>
    <p>
